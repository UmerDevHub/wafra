...
export const categoriesConfig: CategoryConfig[] = [
  {
    ...
    heroImage: "/images/category-selfcare.jpg",
    subcategories: [
  ...
  },
  {
    ...
    heroImage: "/images/category-home-ambience.jpg",
    subcategories: [
  ...
  },
  {
    ...
    heroImage: "/images/category-everyday-comfort.jpg",
    subcategories: [
  ...
  },
  {
    ...
    heroImage: "/images/category-gifting.jpg",
    subcategories: [
...
export const bestSellersData: Product[] = [
  {
    ...
    priceNumber: 89,
    rating: 5,
    image: "/images/product-neck-fan.jpg",
    imageHover: "/images/hero-neck-fan.jpg",
    images: [
      "/images/product-neck-fan.jpg",
      "/images/hero-neck-fan.jpg",
      "/images/category-everyday-comfort.jpg",
      "/images/bundle-on-the-go.jpg",
    ],
    ...
    stockCount: 7,
    variants: [
      { name: "Desert Sage", hex: "#2E473B", image: "/images/product-neck-fan.jpg" },
      { name: "Arctic White", hex: "#FFFFFF", image: "/images/product-neck-fan.jpg" },
      { name: "Midnight Ink", hex: "#2B2420", image: "/images/hero-neck-fan.jpg" },
    ],
    description:
    ...
    reviews: [
      {
        ...
        photos: ["/images/hero-neck-fan.jpg"],
      },
      {
        id: "rev-fan-2",
        author: "Mariam K.",
        ...
        photos: ["/images/product-neck-fan.jpg"],
      },
      {
        id: "rev-fan-3",
        author: "Tariq S.",
  ...
  },
  {
    ...
    priceNumber: 89,
    rating: 5,
    image: "/images/product-ice-roller.jpg",
    imageHover: "/images/hero-ice-roller.jpg",
    images: [
      "/images/product-ice-roller.jpg",
      "/images/hero-ice-roller.jpg",
      "/images/category-selfcare.jpg",
      "/images/bundle-glow-routine.jpg",
    ],
    category: "self-care",
    ...
    stockCount: 5,
    variants: [
      { name: "Blush Pink", hex: "#E5A9A9", image: "/images/product-ice-roller.jpg" },
      { name: "Rose Gold", hex: "#C9714D", image: "/images/product-ice-roller.jpg" },
    ],
    description:
  ...
  },
  {
    ...
    priceNumber: 89,
    rating: 5,
    image: "/images/product-makeup-mirror.jpg",
    imageHover: "/images/hero-makeup-mirror.jpg",
    images: [
      "/images/product-makeup-mirror.jpg",
      "/images/hero-makeup-mirror.jpg",
      "/images/category-selfcare.jpg",
      "/images/bundle-glow-routine.jpg",
    ],
    category: "self-care",
    ...
    stockCount: 5,
    variants: [
      { name: "Pearl White", hex: "#FFFFFF", image: "/images/product-makeup-mirror.jpg" },
      { name: "Soft Blush", hex: "#E5B8AF", image: "/images/hero-makeup-mirror.jpg" },
    ],
    description:
  ...
  },
  {
    ...
    priceNumber: 89,
    rating: 5,
    image: "/images/product-aroma-diffuser.jpg",
    imageHover: "/images/category-home-ambience.jpg",
    images: [
      "/images/product-aroma-diffuser.jpg",
      "/images/category-home-ambience.jpg",
      "/images/bundle-calm-home.jpg",
      "/images/product-sunset-lamp.jpg",
    ],
    ...
    stockCount: 18,
    variants: [
      { name: "Natural Walnut", hex: "#8A5D3B", image: "/images/product-aroma-diffuser.jpg" },
      { name: "Zen White", hex: "#FFFFFF", image: "/images/category-home-ambience.jpg" },
    ],
    description:
  ...
  },
  {
    ...
    priceNumber: 89,
    rating: 5,
    image: "/images/product-bar-necklace.jpg",
    imageHover: "/images/category-gifting.jpg",
    images: [
      "/images/product-bar-necklace.jpg",
      "/images/category-gifting.jpg",
      "/images/bundle-gifting-set.jpg",
      "/images/product-bar-necklace.jpg",
    ],
    category: "gifting",
    ...
    stockCount: 4,
    variants: [
      { name: "18K Gold Plated", hex: "#C9A24B", image: "/images/product-bar-necklace.jpg" },
      { name: "Sterling Silver", hex: "#D8D8D8", image: "/images/category-gifting.jpg" },
      { name: "Rose Gold", hex: "#B76E79", image: "/images/product-bar-necklace.jpg" },
    ],
    description:
...
export const trendingProductsData: Product[] = [
  {
    ...
    priceNumber: 89,
    rating: 5,
    image: "/images/product-sunset-lamp.jpg",
    imageHover: "/images/category-home-ambience.jpg",
    images: [
      "/images/product-sunset-lamp.jpg",
      "/images/category-home-ambience.jpg",
...
export const categoriesData: Category[] = [
  {
    ...
    image: "/images/category-selfcare.jpg",
    subcategories: [
      { name: "Face Care & Rollers", slug: "face-care" },
      { name: "LED Makeup Mirrors", slug: "makeup-mirrors" },
      { name: "Hair Styling Tools", slug: "hair-tools" },
  ...
  },
  {
    ...
    name: "Home Ambience",
    slug: "home-ambience",
    image: "/images/category-home-ambience.jpg",
    subcategories: [
      { name: "Ultrasonic Diffusers", slug: "diffusers" },
      { name: "Mini Humidifiers", slug: "humidifiers" },
      { name: "Sunset & Ambient Lighting", slug: "ambient-lighting" },
  ...
  },
  {
    ...
    name: "Everyday Comfort",
    slug: "everyday-comfort",
    image: "/images/category-everyday-comfort.jpg",
    subcategories: [
      { name: "Portable Neck Fans", slug: "cooling" },
      { name: "Commute & Car Essentials", slug: "on-the-go" },
      { name: "Posture & Desk Wellness", slug: "wellness" },
  ...
  },
  {
    ...
    name: "Gifting",
    slug: "gifting",
    image: "/images/category-gifting.jpg",
    isGifting: true,
    subcategories: [
      { name: "Ayatul Kursi & Faith Jewelry", slug: "faith-jewelry" },
      { name: "Attar & Perfume Oil Sets", slug: "attar-perfume" },
...
export const bundlesData: Bundle[] = [
  {
    ...
    image: "/images/bundle-glow-routine.jpg",
    variant: "default",
  },
  {
    id: "calm-home",
    ...
    originalPrice: "AED 357",
    saveAmount: "Save AED 40",
    image: "/images/bundle-calm-home.jpg",
    variant: "default",
  },
  {
    id: "gifting-set",
    ...
    originalPrice: "AED 357",
    saveAmount: "Save AED 40",
    image: "/images/bundle-gifting-set.jpg",
    variant: "gold",
  },
  {
    id: "on-the-go",
    ...
    originalPrice: "AED 357",
    saveAmount: "Save AED 40",
    image: "/images/bundle-on-the-go.jpg",
    variant: "default",
  },
];
...
export const testimonialsData: Testimonial[] = [
  {
    ...
    productThumbnail: "/images/product-ice-roller.jpg",
    verified: true,
  },
  {
    id: "test-2",
    ...
    productThumbnail: "/images/product-aroma-diffuser.jpg",
    verified: true,
  },
  {
    id: "test-3",
    ...
    avatar: "/images/avatar-mariam.jpg",
    productName: "Ayatul Kursi Bar Necklace",
    productThumbnail: "/images/product-bar-necklace.jpg",
    verified: true,
  },
  {
    id: "test-4",
    ...
    productThumbnail: "/images/product-makeup-mirror.jpg",
    verified: true,
  },
  {
    id: "test-5",
    ...
    productThumbnail: "/images/product-neck-fan.jpg",
    verified: true,
  },
  {
    id: "test-6",
    ...
    productThumbnail: "/images/bundle-glow-routine.jpg",
    verified: true,
  },
  {
    id: "test-7",
    ...
    productThumbnail: "/images/product-sunset-lamp.jpg",
    verified: true,
  },
  {
    id: "test-8",
